    ...
    function(response){
        if (response['responseCode'] != 0) {
            ...
            response['data'].forEach((menu, index_menu) => {
                ...
                iora_inizio.value = (menu['orarioInizio'] != null) ? menu['orarioInizio'].slice(0, 5) : '00:00';
                ...
                iora_fine.value = (menu['orarioFine'] != null) ? menu['orarioFine'].slice(0, 5) : '00:00';
                ...
                baddpiatto.appendChild(document.createTextNode('aggiungi'));
                baddpiatto.addEventListener('click', function(){addDishToMenu(index_menu)})

                parentDiv.appendChild(listpiatti);
                parentDiv.appendChild(datalistpiatti);
                parentDiv.appendChild(baddpiatto);

            });
            

            baddMenu = document.createElement('button');
            baddMenu.appendChild(document.createTextNode('Aggiungi menu'));
