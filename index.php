...
<body>
    ...
    <div><h2>Cosa</h2>
        ...
        <p>La divisione in ruoli permette di centralizzare le informazioni in continuo aggiornamento e allo stesso tempo garantisce una facilità di utilizzo, 
            facendo trasparire solo i dati rilevanti alle singole funzioni svolte dal personale. 
        ...
        <p>La personalizzazione dello spazio di lavoro, dei piatti, dei menù serviti e degli orari delle routine 
            permettono di automatizzare molti dei compiti ai quali sarà richiesto di pensare principalmente una sola volta, alla prima configurazione.</p>
    </div>
    <div><h2>Per chi</h2>
    ...
    <div><h2>Come</h2>
        ...
        Entrambi iniziano dalla registrazione del proprio account nell'area 
        ...
        <h3>Per gli amministratori</h3>
            ...
            <h4>Admin</h4>
                <p>Il pannello di controllo dell'amministratore permette prima di tutto di passare a qualunque altro ruolo, potendo così monitorare l'andamento in ogni settore. 
                    In seguito è possibile aggiungere stanze, con i rispettivi tavoli, aggiungere i piatti disponibili con i relativi parametri e creare nuovi menù. 
                    Per ognuno dei menù è possibile specificare quali piatti gli appartengono e quale sia la sua fascia di attività, 
                    così da rendere immediatamente visibili i piatti corretti in base all'orario.</p>
        ...
        <h3>Per il personale</h3>
            ...
            <h4>Cameriere</h4>
                <p>Viene, innanzitutto, mostrata una mappa dei tavoli del ristorante divisi per stanza e colorati in funzione del loro stato attuale, 
